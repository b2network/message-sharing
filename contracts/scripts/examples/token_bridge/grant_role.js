...
async function main() {
    /**
     * # dev
     * b2dev: yarn hardhat run scripts/examples/token_bridge/grant_role.js --network b2dev
     * asdev: yarn hardhat run scripts/examples/token_bridge/grant_role.js --network asdev
     * # pord
     * as: yarn hardhat run scripts/examples/token_bridge/grant_role.js --network as
     * b2: yarn hardhat run scripts/examples/token_bridge/grant_role.js --network b2
     */
