...
const (
	...
	DepositB2TxStatusExceptionData
)
...
const (
	...
	_
	_
	DepositB2EoaTxStatusWhitelistBtcAddress
	DepositB2EoaTxStatusExceptionData
)
...
type Deposit struct {
	...
	Status            enums.DepositStatus `json:"status" gorm:"type:SMALLINT;default:1"`
}
